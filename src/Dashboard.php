      ...
      <div class="lg:col-span-2 bg-white shadow-md rounded-lg p-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <div class="flex space-x-2">
            <button id="openFormBtn" aria-label="Tambah jadwal baru" class="bg-yellow-400 hover:bg-yellow-500 text-yellow-900 font-bold py-2 px-4 rounded-md flex items-center transition-colors duration-300">
              <i class="fas fa-plus mr-2"></i> Tambah
            </button>
            <button id="lihatSemuaJadwalBtn" class="bg-gray-200 hover:bg-gray-300 text-yellow-900 font-semibold px-4 py-2 rounded-md border border-gray-300">Lihat Semua</button>
          </div>
        </div>
